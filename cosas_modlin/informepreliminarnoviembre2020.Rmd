...
mod_bayes1 <- stan_glm(salario ~ educ + exper + tenure + nonwhite + female + married + numdep + reg.metro + norsur + comserv + profocc + expersq + educsq + i128 + i381 + i440  , data = datos2,
