...
prior_summary(mod_bayes3)



mod_bayes3$stanfit
mod_bayes$coefficients
mcmc_trace(mod_bayes3)
mcmc_trace(mod_bayes3,pars="i440")

pred<-posterior_predict(mod_bayes3,draws = 100)

a=pp_check(mod_bayes3, plotfun = "stat", stat = "mean")
