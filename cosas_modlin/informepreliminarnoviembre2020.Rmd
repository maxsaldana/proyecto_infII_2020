...
<!-- Contábamos con una variable indicadora más, llamada  _"profserv"_ , sobre la cual no poseíamos información por lo que optamos por removerla.  -->
...
<!-- También realizamos algunos modelos lineales simples, que se encuentran en el Anexo. -->
...
```{r pvals.modelo2, results=FALSE, echo=FALSE}
...
```{r muestro.pvals.modelo2, include = TRUE, results=FALSE, echo=FALSE}
...
```{r modelo3, results=FALSE, echo=FALSE}
...
```{r pvals.modelo3, results=FALSE, echo=FALSE}
...
```{r muestro.pvals.modelo3, results=FALSE, echo=FALSE}
...
```{r restricciones, results=FALSE, echo=FALSE}
...
```{r modelo4, results=FALSE, echo=FALSE}
...
```{r graf.res.vs.ygorro, fig.cap="Gráfico de residuos en función de los valores predichos por el modelo.", results=FALSE, echo=FALSE }
...
```{r bptes, results=FALSE, echo=FALSE}
...
```{r qqplot1, fig.width=10, fig.height=3, out.width="100%", fig.cap= "Gráfico QQ-plot", results=FALSE, echo=FALSE}
...
```{r varios.graficos.res,  fig.width=15, fig.height=3, out.width="100%", fig.cap= "Histograma y boxplot de los residuos", results=FALSE, echo=FALSE}
...
```{r test.nor, results=FALSE, echo=FALSE}
...
```{r boxc, results=FALSE, echo=FALSE}
...
```{r modelolog, results=FALSE, echo=FALSE}
...
```{r pvalores.modelolog, results=FALSE, echo=FALSE}
...
```{r pvalores.modelolog2, results=FALSE, echo=FALSE}
...
```{r grafico.residuos.modelolog, results=FALSE, echo=FALSE}
...
```{r bptest.modelolog, results=FALSE, echo=FALSE}
bptest(modelolog2)
```
...
```{r qqplot2, fig.width=10, fig.height=3, out.width="100%", fig.cap= "Gráfico QQ-plot para el modelo logarítmico", results=FALSE, echo=FALSE}
...
```{r varios.graficos.res2, fig.width=15, fig.height=3, out.width="100%", fig.cap= "Histograma y boxplot de los residuos para el modelo logarítmico", results=FALSE, echo=FALSE}
...
```{r test.norm.modelolog, results=FALSE, echo=FALSE}
...
```{r coeficientes.modelolog, results=FALSE, echo=FALSE}
...
<!-- Modelos para el salario no transformado -->
...
```{r modmul2, results=FALSE, echo=FALSE}
...
```{r pvalores.modmul2, results=FALSE, echo=FALSE}
...
```{r muestro.pvalores.modmul2, results=FALSE, echo=FALSE}
...
```{r modmul3, results=FALSE, echo=FALSE}
...
```{r modmul4, results=FALSE, echo=FALSE}
...
```{r grafico.residuos.vs.ygorro, fig.cap="Gráfico de residuos en función de los valores predichos por el modelo.", results=FALSE, echo=FALSE}
...
```{r bptest, results=FALSE, echo=FALSE}
...
```{r varios.graficos.residuos.modmul3, fig.width=10, fig.height=3, out.width="100%", fig.cap="Gráfico QQ Plot.", results=FALSE, echo=FALSE}
...
```{r qqplot.modmul3,  fig.width=15, fig.height=3, out.width="100%", fig.cap="Histograma y boxplots de los residuos.", results=FALSE, echo=FALSE}
...
```{r test.norm, results=FALSE, echo=FALSE}
...
```{r boxcox, fig.cap="Gráfico de la transformación de boxcox, con intervalo de confianza para el valor maximo de lambda.", out.width="75%", results=FALSE, echo=FALSE}
...
```{r modlog, results=FALSE, echo=FALSE}
...
```{r grafico.residuos.modlog, fig.cap="Gráfico de residuos en función de los valores predichos para el modelo logarítmico.", results=FALSE, echo=FALSE}
...
```{r bptest.log, results=FALSE, echo=FALSE}
...
```{r varios.graficos.residuos, fig.width=10, fig.height=3, out.width="100%", fig.cap="Gráfico QQ-Plot para el modelo logarítmico.", results=FALSE, echo=FALSE}
...
```{r qqplot,  fig.width=15, fig.height=3, out.width="100%", fig.cap="Histograma y boxplots de los residuos para el modelo logarítmico.", results=FALSE, echo=FALSE}
...
```{r test.norm.log, results=FALSE, echo=FALSE}
...
```{r eliminacion,  results=FALSE, echo=FALSE}
...
```{r observaciones.atipicas, results=FALSE, echo=FALSE}
...
```{r tratamiento.atipicas, results=FALSE, echo=FALSE}
# dummy <- c(rep(0, 1, 526))
#  dummy[24]=1
#  datos$i24 <- dummy
...
```{r, fig.cap="Gráficos de dispersión del salario en función de los años de educación, para cada región.", results=FALSE, echo=FALSE}
datos %>% 
...
```{r, fig.cap="Gráficos de dispersión del salario en función de la experiencia, para cada región.", results=FALSE, echo=FALSE}
datos %>% 
...
```{r, fig.cap="Gráficos de dispersión del salario en función de los años en el empleo, para cada región.", results=FALSE, echo=FALSE}
datos %>% 
...
## Anexo 4: 
<!-- Gráficos de regresión lineal simples -->
...
```{r, fig.cap="Gráfico de dispersión del salario en función de la educación, con recta de ajuste lineal.", results=FALSE, echo=FALSE}
datos %>% 
  ggplot(aes(educ, salario)) + 
...
```{r, fig.cap="Gráfico de dispersión del salario en función de la experiencia, con recta de ajuste lineal.", results=FALSE, echo=FALSE}
datos %>% 
  ggplot(aes(exper, salario)) + 
  geom_smooth(method = "lm") +
  geom_point() +
...
```{r,  fig.cap="Gráfico de dispersión del salario en función de los años en el empleo, con recta de ajuste lineal.", results=FALSE, echo=FALSE}
datos %>% 
  ggplot(aes(tenure, salario)) + 
  geom_smooth(method = "lm") +
  geom_point() +
